					...
					<div class="col-md-12">
						...
						<div class="card">
							<div class="card-header header-elements-inline">
								<h6 class="card-title">Edit Work Type</h6>
							...
							<div class="card-body">
								...
								<form
									action="${pageContext.request.contextPath}/submitEditWorkType"
									...
									<div class="form-group row">
										...
										<div class="col-lg-10">
											<input type="text" class="form-control"
												placeholder="Work Type" id="typeName" value="${editwork.workTypeName}"
									...
									<div class="form-group row">
										...
										<div class="col-lg-10">
											<input type="text" class="form-control"
												...
												name="typeShortName" autocomplete="off" onchange="checkSame()"  value="${editwork.shortName}"
												maxlength="5"> <span
