			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Employee Short Leave</h5>
					...
					<div class="card-body">
						...
						<form
							action="${pageContext.request.contextPath}/showSLListToEmp"
							...
							<tbody>
								<c:forEach items="${logList}" var="logList" varStatus="count">
									<tr>
										...
										<td>${logList.shLeaveCount}</td>
									 
										<%-- <td class="text-center"><a
											href="${pageContext.request.contextPath}/showEditProjHrs?workLogId=${logList.empId}"><i
